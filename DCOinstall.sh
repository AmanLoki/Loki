...
CONFIG_FILE='dropcoin.conf'
CONFIGFOLDER='/root/.dropcoin'
COIN_DAEMON='/usr/local/bin/dropcoind'
COIN_CLI='/usr/local/bin/dropcoin-cli'
COIN_REPO='https://github.com/TheDropCoinProjectTeam/DropCoin/releases/download/v1.0.0/dropcoin-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='DropCoin'
COIN_PORT=18096
